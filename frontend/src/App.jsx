    ...
    <main className="font-mono">
      ...
      <section className="flex h-screen bg-black/40 text-white backdrop:blur-md">
        <div className="container m-auto  px-4  max-w-4xl">
          ...
          <div className="mt-5">
            <a className="px-9 py-2 bg-emerald-700 hover:bg-emerald-600 transition-all inline-flex justify-center gap-1 items-center  border-b-2 active:border-b-0 active:border-t-2  border-emerald-900 " href="http://resume.nafish.me" target="_blank" rel="noreferrer">
